        ...
        return {
            "start": {
                ...
                "actions": [
                    ...
                    create_tap_action("confirm_name_btn", delay_after=2, timeout=5),
                    create_tap_action("confirm_name_btn", delay_after=2, timeout=5),
                    ...
                    create_tap_action("tutorial_battle_skill_1", delay_after=5, tap_times=5, tap_delay=2),
                    create_tap_action("tutorial_battle_skill_2", delay_after=5, tap_times=2, tap_delay=2),
